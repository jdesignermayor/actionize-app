export default function IntroChatMessage() {
    return <>
        <div className="flex flex-col text-center gap-3 items-center pt-[calc(10%)]">
            <h1 className="text-5xl lg:text-7xl leading-tight bg-clip-text bg-gradient-to-r from-[#FFFFFF] via-[#fff5d6] via-[#fff8df] via-[#ffe8e8] to-[#ffffff]">What do you plan <br /> to get done today?</h1>
