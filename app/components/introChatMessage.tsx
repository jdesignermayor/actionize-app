    ...
    return <>
        <div className="flex flex-col text-center gap-3 items-center pt-[calc(25%)]">
            ...
            <article className="leading-relaxed text-center max-w-md text-sm">
                <p>Welcome to your AI Assistant, for Life-Work Balance, We'll guide you through the process of setting up your goals, tracking your progress, and staying motivated to achieve them.</p>
            </article>
